const cssTestValues = require("../__fixtures__/curriculum-helpers-css");
const htmlTestValues = require("../__fixtures__/curriculum-helpers-html");
const jsTestValues = require("../__fixtures__/curriculum-helpers-javascript");
const whiteSpaceTestValues = require("../__fixtures__/curriculum-helpers-remove-white-space");
const { __testHelpers, removeJSComments } = require("../index");
